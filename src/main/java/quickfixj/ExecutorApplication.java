...
public class ExecutorApplication extends MessageCracker implements Application {
	...
	public void onMessage(quickfix.fix44.NewOrderSingle order, SessionID sessionID)
		...
		try {
			...
			quickfix.fix44.ExecutionReport accept = new quickfix.fix44.ExecutionReport(genOrderID(), genExecID(),
					new ExecType(ExecType.FILL), new OrdStatus(OrdStatus.NEW), order.getSide(),
